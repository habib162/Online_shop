                  ...
                  <div class="row">
                     <div class="form-group col-lg-6">
                      ...
                      <div class="form-group col-lg-6">
                       ...
                       <input type="text" class="form-control" name="unit" {{$product->unit}} required>
                      </div>
                      <div class="form-group col-lg-6">
                        <label for="exampleInputEmail1">Tags</span></label>
                        <input class="form-control" name="tag"value="{{$product->tag}}" data-role="tagsinput">
                      </div>
                  </div> 
                  <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control"data-role="tagsinput"name="color"value="{{$product->color}}">
                        </div>
                        <div class="form-group col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input name="video" class="form-control"value="{{$product->video}}">
                        </div>
                    </div>
                </div>
          ...
          <div class="col-md-4">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                <div class="card p-4">
                    <h6 >Today Deal</h6>
                    <input type="checkbox" name="flash_deal_id"value="1" @if ($product->flash_deal_id==1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="success">
                </div>
                <div class="card p-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#add').click(function(){
            i++;
            $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="file" accept="image/*" name="images[]" class="form-control name_list"/></td><td><button type="button" name="remove" id=" '+i+'" class="btn btn-danger btn_remove">✕</button></td></tr> ');
