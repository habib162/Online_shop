                        ...
                        <ul class="cat_menu"> 
                            ...
                            <li class="hassubs">
                                ...
                                <a href="{{route('categorywise.product',$row->id)}}">
                                    <img src="{{asset($row->icon)}}" alt=""height="10%"width="8%"> {{$row->category_name}}
            ...
            <div class="col">
                ...
                <div class="page_menu_content">
                    ...
                    <div class="menu_contact">
                        <div class="menu_contact_item"><div class="menu_contact_icon"><img src="images/phone_white.png" alt=""></div>+8801521446940</div>
                        <div class="menu_contact_item"><div class="menu_contact_icon"><img src="images/mail_white.png" alt=""></div><a href="hbr4494@gmail.com">hbr4494@gmail.com</a></div>
                    </div>
                </div>
            </div>
        </div>
